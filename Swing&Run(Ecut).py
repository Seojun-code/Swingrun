...
class stage:
    def __init__(self,name):
        ...
        self.end_point=None
    def stage_complete(self,next):
        global now_stage,character_pos
        now_stage=next
        character_pos=p.Vector2(next.start_point.center)
...
while play:
    ...
    if now_stage==stage_1:
        next_stage=stage_2
    elif now_stage==stage_2:
        next_stage=stage_3
    elif now_stage==stage_3:
        next_stage=stage_4
    elif now_stage==stage_4:
        next_stage=stage_5
    elif now_stage==stage_5:
        next_stage=stage_6
    elif now_stage==stage_6:
        next_stage=stage_1

    # 스테이지 클리어
    if colliding(now_stage.end_point):
        now_stage.stage_complete(next_stage)
        swing_end()
        overswing_speed=p.Vector2(0,0)
